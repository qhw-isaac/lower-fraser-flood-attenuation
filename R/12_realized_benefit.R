...
#   6. Cut RI into percentile intervals
#      {0–25, 25–50, 50–60, 60–70, 70–80, 80–85, 85–90, 90–95, 95–100}
#   7. Outliers (PRR_per_NAT > mean + 3·SD) are capped
#
...
for (scen_dir in scenarios) {
  ...
  # PRR per natural km^2 (provision intensity)
  prr_per_nat <- ifelse(sb$natural_km2 > 0, prr_total / sb$natural_km2, 0)

  # uutlier cap at mean + 3*SD over non-zero sub-basins
