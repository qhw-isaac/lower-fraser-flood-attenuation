...
# ------------------------------------------------------------------------------
# For each sub-basin j, sum the demand of every downstream basin i, 
# weighted by flow distance from j to i
#
# Inputs: 02_subbasins.gpkg, 02_topology.csv, 10_demand_subbasin.gpkg
#
# Outputs (data/processed/):
#   11_tda_subbasin.gpkg
#       columns:
#         HYBAS_ID, in_downstream_aoi, admin_district,
...
# drop any edge whose ds_id isn't a known vertex
sb_ids <- sb$HYBAS_ID
